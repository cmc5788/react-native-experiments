...
/**
 * Default root view for catalyst apps. Provides the ability to listen for size changes so that a
 * UI
 ...
 * that gesture).
 */
public class LiteReactRootView extends SizeMonitoringFrameLayout implements RootView {
  ...
  public LiteReactRootView(Context context) {
    super(context);
  }

  public LiteReactRootView(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public LiteReactRootView(Context context, AttributeSet attrs, int defStyle) {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    // Comment out this React stuff with extreme prejudice
    //setMeasuredDimension(MeasureSpec.getSize(widthMeasureSpec),
    //    MeasureSpec.getSize(heightMeasureSpec));

    // ... let Android be Android instead.
  ...
  // */
  //public void startReactApplication(LiteReactInstanceManager reactInstanceManager,
  //    String moduleName) {
   ...
   */
  public void startReactApplication(LiteReactInstanceManager reactInstanceManager,
      String moduleName, @Nullable Bundle launchOptions) {
   ...
   * application. If {@link #startReactApplication} is called, this method must be called before
   * the
   * LiteReactRootView is garbage collected (typically in your Activity's onDestroy, or in your
   * Fragment's
   * onDestroyView).
   */
  ...
  protected void finalize() throws Throwable {
    ...
    Assertions.assertCondition(!mIsAttachedToInstance,
        "The application this LiteReactRootView was rendering was not unmounted before the LiteReactRootView "
            +
            "was garbage collected. This usually means that your application is leaking large amounts of "
            +
            "memory. To solve this, make sure to call LiteReactRootView#unmountReactApplication in the onDestroy() "
            +
